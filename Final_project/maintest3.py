...
from speed_helper import calculate_speed, calculate_distance
...
# Global variables for speed, distance, and ascent
...
# Main function
def main():
    global previous_latitude, previous_longitude, previous_time, previous_altitude
    global total_distance, pressure_history
    ...
    try:
        while True:
            ...
            # Calculate speed, distance, and ascent
            current_time = datetime.now()
            speed = calculate_speed(previous_latitude, previous_longitude, previous_time, latitude, longitude, current_time)
            total_distance = calculate_distance(previous_latitude, previous_longitude, latitude, longitude, total_distance)
            ascent, current_altitude = calculate_ascent(pressure, pressure_history, previous_altitude, sea_level_pressure)
            ...
            print(f"Speed: {speed} km/h, Distance: {total_distance} km, Ascent: {ascent} m")
